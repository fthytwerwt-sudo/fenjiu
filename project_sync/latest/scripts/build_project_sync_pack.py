...
ALLOWLIST = (
    ...
    "docs/strategy/SALES_FIRST_MASTER_PLAN.md",
    "docs/strategy/CURRENT_TO_TARGET_GAP_ANALYSIS.md",
    "docs/strategy/SALES_SYSTEM_TARGET_ARCHITECTURE.md",
    "docs/strategy/SALES_EXECUTION_PHASES.md",
    "docs/strategy/CHANNEL_ROLE_MATRIX.md",
    ...
    "docs/implementation/source_catalogs/README.md",
    "docs/implementation/source_catalogs/fenjiu_sources.yaml",
    "docs/implementation/source_catalogs/seafood_sources.yaml",
