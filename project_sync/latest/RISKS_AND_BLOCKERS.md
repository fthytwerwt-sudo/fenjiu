...
| R-11 | **PARTIAL / real acquisition governance（真实获客治理）** | Source Catalog 已明确最小公司级企业发现来源、来源条款和拒绝路线；仍缺联系人处理依据、DNC/删除/保留、私有存储、真实身份/RBAC、供应链批准事实与外发停止线 | 仅可开始单业务线、低频、公司级企业发现与企业官网交叉验证；不得把候选、联系方式、评分或目录资料写入真实 CRM、Gmail 或外联链路 | 按两份 Source Catalog 另建最小发现任务；联系人处理、CRM 与外发仍须 P08-RAB 治理/合同及书面证据解除 |
