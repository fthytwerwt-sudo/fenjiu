...
| R-10 | **PARTIAL / production boundary** | P02-01 至 P02-03、P03-01 至 P03-03、P04-01 至 P04-03 与 P05-01 已在 `main` 远端回读；当前仅提供 local synthetic 的 workflow、策略/审计和来源 snapshot 合同，仍缺 RLS、加密、retention、法域、真实 scope、authenticated identity/authorization、database adapter/driver、真实 parser/OCR/storage、生产抓取/队列/审计与 production connection | 不得把 local migration、trigger、in-memory policy/read/audit、fake extraction、mapping fingerprint、isolated approved synthetic version、workflow、action-policy、observability 或 source-policy contract（来源政策合同）写成生产数据隔离、真实审批、真实网站访问、可联系 lead/contact、数据合规或真实资料可导入 | 真实资料和生产路径须另行获得范围、合规、连接与用户授权；后续工程任务仍须从新干净 worktree 开始 |
